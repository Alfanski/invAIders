...
| `CONVEX_WEBHOOK_SECRET`       | Convex + Vercel env var               |
...
| `INTERNAL_API_TOKEN`          | Vercel env var (analyze-workout auth) |
...
Custom agent skills framework. Skills: implement, debug, refactor,
